...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    final user = Provider.of<UserDetails>(context).userId.toString();
    
    return Scaffold(
  appBar: AppBar(
    foregroundColor: whiteColor,
    backgroundColor: primary,
    title: Text1(fontColor: whiteColor, fontSize: 22, text: "My Feedbacks",weight: FontWeight.bold),
    centerTitle: true,
    actions: [
  ...
  stream: FirebaseFirestore.instance
      .collection('feedbacks').where('userId', isEqualTo: user)
